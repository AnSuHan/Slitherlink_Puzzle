...
class GameSceneSquareProvider extends StatefulWidget {
  ...
  const GameSceneSquareProvider({
    Key? key, required this.isContinue, required this.loadKey
  }) : super(key: key);

  @override
  GameSceneStateSquareProvider createState() => GameSceneStateSquareProvider();
}
...
class GameSceneStateSquareProvider extends State<GameSceneSquareProvider> {
  ...
  void updatePuzzle() {
    ...
    _provider.changeColor(context, 0, 0, "up", const Color(0xFF000000));
  }
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider( // ChangeNotifierProvider 사용
      ...
      child: Consumer<SquareProviderProvider>(
